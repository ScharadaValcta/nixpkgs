{ stdenv, fetchFromGitHub, python3, libaacs, libbdplus, libbluray, makemkv, handbrake, ffmpeg, mplayer, bash, coreutils, findutils, gawk, gnutar, gzip, utillinux, perl, mediainfo, tesseract, python3Packages, lib }:
